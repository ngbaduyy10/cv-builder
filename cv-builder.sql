...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2025 at 05:59 AM
...
INSERT INTO `template` (`id`, `name`, `description`, `preview_image`, `active`, `created_at`, `updated_at`, `type_id`) VALUES
(1, 'Santiago', 'Classic full-page resume template with sizable resume sections.', 'https://s3.resume.io/cdn-cgi/image/width=380,dpr=2,format=auto/uploads/local_template_image/image/383/persistent-resource/santiago-resume-templates.jpg?v=1656070649', 1, '2025-03-27 05:06:39', '2025-04-04 00:34:14', 1),
(2, 'Sydney', 'Modern and eye-catching resume template. Beautiful contrasting structure.', 'https://s3.resume.io/cdn-cgi/image/width=380,dpr=2,format=auto/uploads/local_template_image/image/441/persistent-resource/sydney-resume-templates.jpg?v=1651657428', 1, '2025-03-27 05:54:38', '2025-04-02 03:50:31', 1),
(3, 'Vienna', 'Striking modern header, professional two column template structure.', 'https://s3.resume.io/cdn-cgi/image/width=380,dpr=2,format=auto/uploads/local_template_image/image/406/persistent-resource/vienna-resume-templates.jpg?v=1656070334', 1, '2025-03-27 05:56:52', '2025-04-02 03:50:34', 1),
(4, 'Milan', 'Streamlined professional resume template with a human touch.', 'https://s3.resume.io/cdn-cgi/image/width=380,dpr=2,format=auto/uploads/local_template_image/image/504/persistent-resource/milan-resume-templates.jpg?v=1652261853', 1, '2025-03-30 12:13:46', '2025-04-02 03:50:37', 1);
...
(5, 'Nhat Hoang', 'nhathoang@gmail.com', '$2y$10$St6bpsKEMRbKZhTtXbR1YeTSyrUx5pTuJCR8klKtp8vCO8sugHRoq', NULL, 'admin', '2025-04-03 12:16:11');
